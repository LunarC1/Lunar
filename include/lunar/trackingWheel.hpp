...
class TrackingWheel {
    public:
         ...
         * lunar::TrackingWheel verticalTrackingWheel(&verticalEncoder, lunar::Omniwheel::NEW_275, -5);
         ...
         * lunar::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, lunar::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * lunar::TrackingWheel leftTrackingWheel(&leftMotors, lunar::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by lunar, this will automatically be called when
         ...
         *     lunar::TrackingWheel exampleTrackingWheel(&exampleEncoder, lunar::Omniwheel::NEW_275, 0.5);
         ...
         *     lunar::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, lunar::Omniwheel::NEW_275, 0.5);
